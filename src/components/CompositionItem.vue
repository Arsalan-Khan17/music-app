<template>
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      <div class="text-white text-center font-bold p-4 rounded mb-4" v-if="show_alert" :class="alert_variant">
        {{alert_msg}}
      </div>
...
export default {
  ...
  data(){
    return{
      ...
      alert_msg : 'Please wait! Uploading song info'
    }
  },
  methods:{
    async edit(values) {
      ...
      this.alert_msg = 'Please wait! Uploading song info';
      ...
      this.alert_msg = 'Song Info updated Successfully';
